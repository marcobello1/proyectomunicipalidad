...
CREATE TABLE `users` (
  ...
  `domicilio` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `telefono` int(20) unsigned NOT NULL,
  `tipousuario` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
...
-- Dump completed on 2022-08-31 19:31:12
